...
CREATE TABLE IF NOT EXISTS payment_qr_assets (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE INDEX IF NOT EXISTS idx_payment_qr_assets_updated_at ON payment_qr_assets(updated_at);
CREATE INDEX IF NOT EXISTS idx_payment_qr_assets_created_at ON payment_qr_assets(created_at);
...
INSERT OR IGNORE INTO system_settings (key, value, is_secret, updated_at) VALUES
  ...
  ('collect_qr_asset_id', '', 0, datetime('now')),
